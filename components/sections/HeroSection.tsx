...
export default function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden flex items-center justify-center bg-[var(--background)]">
      ...
      {/* Foreground CTA */}
      <div className="absolute bottom-32 md:bottom-36 lg:bottom-40 z-20 flex flex-col items-center w-full px-6 pointer-events-auto">
        <p className="text-lg md:text-xl font-bold mb-6 text-black/70 max-w-lg text-center bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full border border-black/5 pointer-events-none">
